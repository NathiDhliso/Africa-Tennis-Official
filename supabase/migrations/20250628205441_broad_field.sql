/*
  # Match Highlights and Video Recording Support
  
  1. New Tables
    - `match_highlights` - Stores video highlights with metadata
  
  2. Changes
    - Add 'video_recorded' to valid event types in match_events
